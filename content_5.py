...
pillar5_modules = [
    ...
    "quiz": [
      {
        ...
        "options": [
          "Ad conversion rate",
          "Organic conversion rate (orders per page visit)",
          "Return rate",
          "Buy Box win rate"
        ],
  ...
  },
  {
    ...
    "videos": [
      {
        "id": "GGLI_aIUO0M",
        "title": "Post-Purchase Excellence on Amazon India"
      }
    ],
    "checklist": [
    ...
    "quiz": [
      {
        ...
        "options": [
          ...
          "Usage instructions",
          "QR code to how-to videos",
          "Discount offer in exchange for a positive review"
        ],
